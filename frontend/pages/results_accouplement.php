...
<body>
    ...
    <section>
            ...
            <div id="list_result" data-aos="fade-down">
                <div id="title_list_results">
                    <ul>
                        ...
                        <li>
                            <p class="title_list_results_item">Région</p>
                        </li>
                    </ul>
                </div>
                <div id="results" data-aos="fade-down">

                    <?php $sql = "SELECT *  from animal where famille='accouplement' ";
                    ...
                    if ($query->rowCount() > 0) {
                        foreach ($results as $result) {  ?>
                            <ul>
                                <li>
                                    <a href="detail-animal.php?vhid=<?php echo htmlentities($result->id); ?>"> <img src="../../img/animal/<?php echo htmlentities($result->img); ?>" alt="image"></a>
                                </li>
                                <li>
                                    <p class="title_list_results_item"> <?php echo htmlentities($result->description); ?></p>
                                </li>
                                <li>
                                    <p class="title_list_results_item"> <?php echo htmlentities($result->city); ?></p>
                                </li>
                            </ul>
                    <?php }
                    } ?>
                    <ul>
                        <li>
                            <img src="../ressources/images/slideshow1.jpg" alt="animal_picture">
                        </li>
                        <li>
                            <p class="title_list_results_item">Femelle Race pure en bonne santée</p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>
                            <img src="../ressources/images/slideshow2.jpg" alt="animal_picture">
                        </li>
                        <li>
                            <p class="title_list_results_item">chat femelle, chien male </p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>
                            <img src="../ressources/images/slideshow3.jpg" alt="animal_picture">
                        </li>
                        <li>
                            <p class="title_list_results_item"> carnet de santé disponible</p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>
                            <img src="../ressources/images/slideshow4.jpg" alt="animal_picture">
                        </li>
                        <li>
                            <p class="title_list_results_item">chien buldogg de race pure bien tenu</p>
                        </li>
                        <li>
                            <p class="title_list_results_item">belvedere</p>
                        </li>
                    </ul>
                    <ul>
                        <li>
        ...
        <div id="ajouter">
            <a href="../../ajouter-animal-accouplment.php"> Ajouter +</a>
        </div>
