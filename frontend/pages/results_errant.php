...
<body>
    ...
    <section>
            ...
            <div id="list_result" data-aos="fade-down">
                ...
                <div id="results" data-aos="fade-down">
                    ...
                    if ($query->rowCount() > 0) {
                        foreach ($results as $result) {  ?>
                            <ul>
                                ...
                                <li>
                                    <p class="title_list_results_item"> <?php echo htmlentities($result->blasa); ?></p>
                                </li>
                    ...
                    <ul>
                        ...
                        <li>
                            <p class="title_list_results_item">Chien 3 mois, pres de la poste</p>
                        </li>
                        <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <p class="title_list_results_item">2 animaux besoins d'aide</p>
                        </li>
                        <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <p class="title_list_results_item">chien buldogg</p>
                        </li>
                        <li>
        ...
        <div id="ajouter">
            <a href="../../ajouter-animal-errant.php"> Ajouter +</a>
        </div>
