...
<body>
    ...
    <section>
            ...
            <div id="list_result" data-aos="fade-down">
                ...
                <div id="results" data-aos="fade-down">
                    ...
                    if ($query->rowCount() > 0) {
                        foreach ($results as $result) {  ?>
                            <ul>
                                ...
                                <li>
                                    <p class="title_list_results_item"><?php echo htmlentities($result->descr); ?></p>

                                </li>
                                <li>
                                    <p class="title_list_results_item"> <?php echo htmlentities($result->lieu); ?></p>
                                </li>
                            </ul>
                    <?php }
                    } ?>
                    <ul>
                        ...
                        <li>
                            <p class="title_list_results_item">Chien 3 mois, repond au nom de onichan</p>
                        </li>
                        <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <p class="title_list_results_item">chien et chat volé</p>
                        </li>
                        <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <p class="title_list_results_item">chien buldogg 5mois de comme dans la photo, recompense promise</p>
                        </li>
                        <li>
        ...
        <div id="ajouter">
            <a href="../../ajouter-animal-perdu.php"> Ajouter +</a>
        </div>
