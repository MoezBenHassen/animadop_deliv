...
$sql = "delete from admin_magasin  WHERE  id=:delid";
...
<head>
	...
	<title>Admin  |admin_magasin </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Liste Admin Magasin</h2>
						<div class="panel panel-default">
    <div class="panel-heading">Admin_Mag Details</div>
...
<?php $sql = "SELECT * from admin_magasin";
$query = $dbh -> prepare($sql);
$query->execute();
...
{?>	
			<tr>
		        ...
		        <td><a href="list-admin.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
			</tr>
			<?php $cnt=$cnt+1; }} ?>
										
		</tbody>
	</table>
	<a href="ajout-admin.php"><i class="fa fa-plus-circle"></i> Ajouter</a>
