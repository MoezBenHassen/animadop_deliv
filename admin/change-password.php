...
$sql ="SELECT password FROM administrateur WHERE username=:username and password=:password";
...
if($query -> rowCount() > 0)
{
$con="update administrateur set password=:newpassword where username=:username";
