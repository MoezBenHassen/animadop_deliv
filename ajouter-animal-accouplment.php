...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO animal(nome,race,famille,sexe,img,city,description,id_user) VALUES(:nome ,:race,:famille,:sexe,:img,:city,:description,16)";
...
<head>
    ...
    <title>Ajout_accouplement</title>
    <!--BOOTSTRAP CDN-->
    ...
    <section>
        <section id="main_body1">
            ...
            <div id="list_result" data-aos="fade-down">
                ...
                <img src="frontend/ressources/images/x2.png" alt="logo-animadop" id="f1">
                <div id="formContainer">
                    <form method="post" enctype="multipart/form-data" action="ajouter-animal-accouplment.php">
                        ...
                        <div id="formContainer">
                            ...
                            <div style="display: flex;flex-direction: column;">
                                <div class="formItem">
                                    ...
                                    <input type="text" name="famille" value="accouplement" readonly />
                                </div>
                                <div class="formItem">
