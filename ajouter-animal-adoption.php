...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO animal(nome,race,famille,sexe,img,description,city,id_user) VALUES(:nome ,:race,:famille ,:sexe,:img,:descr,:city,16)";
        $query = $dbh->prepare($sql);
        $query->bindParam(':nome', $name, PDO::PARAM_STR);
        $query->bindParam(':race', $race, PDO::PARAM_STR);
        $query->bindParam(':famille', $famille, PDO::PARAM_STR);
        ...
        <section>
            <section id="main_body1">
                ...
                <div id="list_result" data-aos="fade-down">
                    <h2 id="titre_ajout">Ajouter animal</h2>
                    <img src="frontend/ressources/images/x1.png" alt="logo-animadop" id="f1">

                    <div id="formContainer">

                        <form method="post" enctype="multipart/form-data" action="ajouter-animal-adoption.php">
                            ...
                            <div id="formContainer">
                                ...
                                <div style="display: flex;flex-direction: column; margin: 0px 40px 0px 40px;">
                                    ...
                                    <div class="formItem">
                                        ...
                                        <button type="reset" class="btn btn-primary  button_color">Cancel</button>
                                        <button name="submit" class="btn btn-primary  button_color" type="submit">Save changes</button>
                                    </div>
                                ...
                                <div style="display: flex;flex-direction: column;">
                                    <div class="formItem">
                                        ...
                                        <input type="text" name="famille" value="adoption" readonly />
                                    </div>
                                    <div class="formItem">


                                        <input type="text" name="city" placeholder="Lieu" required>
                                    </div>
                                    <div class="formItem">
