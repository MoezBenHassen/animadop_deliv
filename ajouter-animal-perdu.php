...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO perdu(descr,date,lieu,img) VALUES(:description ,:date,:lieu,:img)";
        ...
        <section>
            <section id="main_body1">
                ...
                <div id="list_result" data-aos="fade-down">
                    <h2 id="titre_ajout">Animal Perdu</h2>
                    <img src="frontend/ressources/images/x4.png" alt="logo-animadop" id="f1">
                    <form method="post" enctype="multipart/form-data" action="ajouter-animal-perdu.php">
                        <div id="formContainer">
                            ...
                            <div style="display: flex;flex-direction: column; margin: 0px 40px 0px 40px;">
                                ...
                                <div class="formItem">
                                    ...
                                    <textarea name="descr" rows="3" placeholder="description"></textarea>
                                </div>
